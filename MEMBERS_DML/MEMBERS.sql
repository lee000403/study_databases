...
CREATE TABLE MEMBEWRS_LOGIN
(
  EMAIL             VARCHAR(50) NOT NULL COMMENT '이메일',
  MEMBERS_ID        VARCHAR(50) NOT NULL COMMENT '유니크 ID',
  MEMBEWRS_LOGIN_ID VARCHAR(50) NOT NULL COMMENT '회원_로그인 ID'
) COMMENT '회원_로그인';

ALTER TABLE MEMBEWRS_LOGIN
  ADD CONSTRAINT FK_MEMBERS_TO_MEMBEWRS_LOGIN
    FOREIGN KEY (MEMBERS_ID)
    REFERENCES MEMBERS (MEMBERS_ID);

ALTER TABLE HOBBY_CODE
  ADD CONSTRAINT FK_MEMBERS_TO_HOBBY_CODE
    FOREIGN KEY (MEMBERS_ID)
    REFERENCES MEMBERS (MEMBERS_ID);
